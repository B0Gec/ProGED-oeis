...
% Although the algorithms based on Buchberger's algorithm were already applied to identify systems of ordinary differential 
% equations,
% to best of our knowledge, the part of the equation discovery field concerning algebraic equations (including the so called exact equations) has not been researched by such algorithms.
...
% We propose that the problem of equation discovery can be seen as a problem of finding a basis of the vanishing ideal of the data set.
