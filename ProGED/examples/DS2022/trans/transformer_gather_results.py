...
# icol = results_transformer_100.columns[0]
for icol in results_transformer.columns:
    ...
    for iexpr in expr_merged:
        ...
        if sys_name == 'lorenz':
            ...
            sys_func.append(eval('lambda x_0, x_1, t: ' + iexpr))
        else:
...
column_names = ['method', 'exp_type', 'data_v'
                                      'ersion', 'system', 'snr', 'iinit', 'ibest', 'duration',
